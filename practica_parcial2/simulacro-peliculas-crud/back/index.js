...
app.get("/api/peliculas", async (req, res) =>{
    const titulo = req.query.titulo // estos req.query son los veiene despues del ? en la url
    const incluirTodos = req.query.incluirTodos
    // codigo
    const peliculas = await peliculasService.getPeliculas(titulo, incluirTodos);
    // retorno respueta
    res.json(peliculas);
})

...
import ConsultarPiloto from './Consultar';

export default function RegistrarPiloto() {
    ...
    const onSubmit = async (data) => {
        ...
        await pilotosService.post(data)
    ...
    return (
        <div className='container_app'>
            ...
            <div>
            <ConsultarPiloto></ConsultarPiloto>
            </div>
        </div >
